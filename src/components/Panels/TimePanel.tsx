...
const TimePanel = (
    (
        { selectedCategory, showThisSection, setShowThisSection, startTime,
setStartTime,
cycles,
setCycles,
intervalCount,
                        ...
                        <div className="grid w-full grid-cols-3 gap-3">
                            ...
                            {selectedCategory === "Recurring" && (
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            placeholder="1"
                                            id="c-1"
                                            className="rounded bg-[#262229] text-white px-3 py-2"
                            ...
                            {selectedCategory === "Recurring" && (
                                        ...
                                        <div>
                                            ...
                                            <Modal open={isOpen} onClose={closeModal} title="Recurring Schedule">
                                                ...
                                                <div className="grid grid-cols-5 items-center gap-3 px-6 py-4">
                                                    <span className="col-span-2 w-full h-full text-[#AFAEAE] flex items-center">
                                                        Repeat Every
                                                    </span>
                                                    <Input
                                                        type="text"
                                                        placeholder="1"
                                                        id="c-1"
                                                        className="col-span-1 w-full h-full rounded bg-[#262229] text-white"
                                                        value={intervalCount}
